...
import com.ssafy.tab.exception.UnAuthorizedException;
...
//			return testMap;
    ...
    public LinkedHashMap<String,Object> getUserToken() {
        return (LinkedHashMap<String,Object>)this.get("user").get("user");
    }

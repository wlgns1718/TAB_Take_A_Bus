...
public class BusStationController {
    ...
    public ResponseEntity<Map<String, Object>> StationAPI(@PathVariable("cityCode") @ApiParam(value = "도시코드", required = true) String cityCode, @PathVariable("stationId") @ApiParam(value = "정류장 고유 번호", required = true) String stationId, @PathVariable("stationName") @ApiParam(value = "정류장 한글 이름", required = true) String stationName) throws IOException {
        Map<String, Object> resultMap = new HashMap<>();
        //모든 노선을 저장.
        try{
